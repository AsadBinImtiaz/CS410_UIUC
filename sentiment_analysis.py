...
az_reviews_df = 'data/az_reviews_df.pkl'
vocab_file = 'data/vocab.pkl'
transformed_x_file = 'data/transformed_x.pkl'
...
def read_az_reviews():
    bucket = 'cs410-yelp'
    data_key = 'processed_data/reviews_az.csv'
...
def init_transformation(x):
    logger.info("init_transformation::start-time --->  {}".format(
    ...
    logger.info("init_transformation::end-time --->  {}".format(
        datetime.datetime.now().time()))
...
def vectorize(vocab, xx):
    logger.info("vectorize::start-time --->  {}".format(
        datetime.datetime.now().time()))
    start_time = time.time()
    ...
    logger.info("vectorize::end-time --->  {}".format(
        datetime.datetime.now().time()))
    logger.info("Elapsed: {} seconds".format(round(time.time() - start_time,
                                                   4)))
    return x
...
def multinomial_naive_bayes(x_train, x_test, y_train, y_test):
    logger.info("multinomial_naive_bayes::start-time --->  {}".format(
        datetime.datetime.now().time()))
    start_time = time.time()
    ...
    logger.info("multinomial_naive_bayes::end-time --->  {}".format(
        datetime.datetime.now().time()))
    logger.info("Elapsed: {} seconds".format(round(time.time() - start_time,
                                                   4)))
    return mnb
...
def random_forest_classifier(x_train, x_test, y_train, y_test):
    logger.info("random_forest_classifier::start-time --->  {}".format(
        datetime.datetime.now().time()))
    start_time = time.time()
    ...
    logger.info("random_forest_classifier::end-time --->  {}".format(
        datetime.datetime.now().time()))
    logger.info("Elapsed: {} seconds".format(round(time.time() - start_time,
                                                   4)))
    return rmfr
...
def SVM(x_train, x_test, y_train, y_test):
    logger.info("SVM::start-time --->  {}".format(
        datetime.datetime.now().time()))
    start_time = time.time()
    ...
    logger.info("SVM::end-time --->  {}".format(
        datetime.datetime.now().time()))
    logger.info("Elapsed: {} seconds".format(round(time.time() - start_time,
                                                   4)))
    return svm
...
def multilayer_perceptron(x_train, x_test, y_train, y_test):
    logger.info("multilayer_perceptron::start-time --->  {}".format(
        datetime.datetime.now().time()))
    start_time = time.time()
    ...
    logger.info("multilayer_perceptron::end-time --->  {}".format(
        datetime.datetime.now().time()))
    logger.info("Elapsed: {} seconds".format(round(time.time() - start_time,
                                                   4)))
    return mlp
...
def kNN(x_train, x_test, y_train, y_test):
    logger.info("kNN::start-time --->  {}".format(
        datetime.datetime.now().time()))
    start_time = time.time()
    ...
    logger.info("kNN::end-time --->  {}".format(
        datetime.datetime.now().time()))
    logger.info("Elapsed: {} seconds".format(round(time.time() - start_time,
                                                   4)))
    return knn
...
def decision_tree(x_train, x_test, y_train, y_test):
    logger.info("decision_tree::start-time --->  {}".format(
        datetime.datetime.now().time()))
    start_time = time.time()
    ...
    logger.info("decision_tree::end-time --->  {}".format(
        datetime.datetime.now().time()))
    logger.info("Elapsed: {} seconds".format(round(time.time() - start_time,
                                                   4)))
    return dt
...
def upload_files_to_s3():
    ...
    SOURCE_FILENAMES = [
        'data/az_reviews_df.pkl', 'logs/info.log', 'logs/errors.log',
        'data/vocab.pkl'
    ]
...
def main():
    setup_logging()
    logger.info("main::start-time --->  {}".format(
        datetime.datetime.now().time()))
    start_time = time.time()
